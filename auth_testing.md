...
"
NOTE: use the actual DB_NAME from backend/.env instead of 'test_database' if different.

Step 2: Test Backend API
curl -X GET "https://your-app.com/api/auth/me" -H "Authorization: Bearer YOUR_SESSION_TOKEN"
Protected endpoints: include Authorization: Bearer header or session_token cookie.
...
- Browser loads main app (not login view) when session cookie set
